...
const FlutterwaveSchema = require('../models/Flutterwave');
...
const chargeCard = asyncHandler(async (req, res, next) => {
    try {
        ...
        const flw = new Flutterwave('FLWPUBK_TEST-8d0a295ee1a7bf791dd81ad8ab338662-X', 'FLWSECK_TEST-fa43174bb9713015ad3b3c1078cbd2b1-X');
        let  {
            card_number,
            cvv,
            expiry_month,
